...
```bash
curl -sL https://raw.githubusercontent.com/larreblarsson/SCARPA-Connection-Manager/main/install.sh | bash
```
...
# Add the repository
echo "deb [signed-by=/usr/share/keyrings/SCARPA-Connection-Manager-keyring.gpg] https://larreblarsson.github.io/SCARPA-Connection-Manager stable main" | sudo tee /etc/apt/sources.list.d/SCARPA-Connection-Manager.list
